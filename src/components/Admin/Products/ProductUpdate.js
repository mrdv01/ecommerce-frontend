...
import { fetchProductAction, resetUpdateState, updateProductAction } from "../../../redux/slices/products/productsSlice";
...
export default function ProductUpdate() {
  ...
  // Sync formData with the product when it's updated
  useEffect(() => {
    if (product?.product) {
      setFormData({
  ...
  useEffect(() => {
    if (isUpdated) {
      ...
      // Reset `isUpdated` flag in the Redux state
  ...
  return (
    <>
      ...
      {fileErrs?.length && <ErrorMsg message="file too large or upload an image" />}
